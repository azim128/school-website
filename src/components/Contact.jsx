  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen dark:bg-black">
         <div className="text-center">
          <h1 className="text-4xl  lg:text-5xl font-medium mb-4 leading-tight dark:text-white">Contact Us</h1>
        </div>
      <div className="bg-white dark:bg-gray-700 rounded-lg shadow-lg p-8 md:w-[75%] w-[95%]">
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="bg-green-500 hover:bg-green-600 text-white rounded py-2 px-4 mb-4">Submit</button>
        </form>
      </div>
      <ToastContainer />
    </div>
